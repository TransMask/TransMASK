...
### Clone this Repo
```
git clone https://github.com/TransMask/TransMASK.git
cd TransMASK
```
...
The details about the dataset structure can be found here: https://huggingface.co/datasets/TransMask/Dataset

## Train
To train a Behavior Cloning (BC) policy, run the following command:
